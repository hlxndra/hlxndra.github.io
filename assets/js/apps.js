/*
Template Name: MDriven World - Responsive Admin Dashboard Template build with Twitter Bootstrap 3.3.7
Version: 2.1.0
Author: Sean Ngu
...
/* Mobile rside navigation */

var rsidemenu = function() {
    var rsideToggle = document.querySelector('.rside__toggle');
    var rside = document.querySelector('.rside');

    rsideToggle.addEventListener('click', function() {
        if(rside.classList.contains('rside--open')) {
            rside.classList.remove('rside--open');
            rside.classList.add('rside--closed');
        } else {
            rside.classList.remove('rside--closed');
            rside.classList.add('rside--open');
        }
    });
}
